...
be unmoved by a filled-in row.

The claim we actually make is that these choices are \emph{mutually entailed}---each one is what
makes another one valid---so that the set is a consequence of L1 and L2 rather than a
collection of independently attractive features.
