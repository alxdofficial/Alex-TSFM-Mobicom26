...
resolvability table that had pooled evaluation datasets into a training-only measurement, and they
currently refuse every gate artifact fitted before the completed encoder, which is why this paper
reports no enrollment result rather than one carried over from a superseded checkpoint.
