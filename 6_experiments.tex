...
material---harnet is pretrained on roughly $700$k person-days against our ${\sim}570$
...
This is the headline experiment. At each budget $k$ of labelled target windows per class we
compare three mechanisms on identical data: HALO's memory, given the exemplars as an append with
