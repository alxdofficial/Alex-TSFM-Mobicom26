...
\begin{table}[h]
  ...
  Window counts are six-second windows on the native-rate grid after physical-plausibility
  filtering. InclusiveHAR comprises 10 able-bodied and 10 physically disabled subjects.
